              ...
              <div class="card bg-light d-flex flex-fill">
                ...
                ?>
                  <div class="row">
                    ...
                    <p class="text-muted text-sm"><b>JK: </b> <?= htmlspecialchars($rs['jk']); ?></p>
                    <p class="text-muted text-sm"><b>Tmp_Lahir: </b> <?=htmlspecialchars($rs['tmp_lahir']); ?></p>
                    <p class="text-muted text-sm"><b>Tgl_Lahir: </b> <?= htmlspecialchars($rs['tgl_lahir']); ?></p>
